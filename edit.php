...
?> 
    <tr class="editor">
     ...
     <td class="editor"><input type="text" name="Last_Name" value="<?=$atRow['Last_Name']?>" required ></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">First Name:</div></td>
     <td class="editor"><input type="text" name="First_Name" value="<?=$atRow['First_Name']?>" required ></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">Middle Initial:</div></td>
     <td class="editor"><input type="text" name="Middle_Initial" value="<?=$atRow['Middle_Name']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">Suffix:</div></td>
     <td class="editor"><input type="text" name="Suffix_Name" value="<?=$atRow['Suffix_Name']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">DOB:</div></td>
     <td class="editor"><div class="ed1"><input type="text" name="DOB" value="<?=$atRow['DOB']?>" required ></td>
    </tr>
<?
      }
?>
    ...
    <tr class="editor">
     ...
     <td class="editor"><input type="text" name="Tag" value="<?=$atRow['Tag']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">Category:</div></td>
     <td class="editor"><input type="text" name="Category" value="<?=$atRow['Category']?>"></td>
    </tr>
    <tr class="editor">
...
?> 
    ...
    <tr class="editor">
     ...
     <td class="editor"><input type="text" name="Address" value="<?=$atRow['Address']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">City:</div></td>
     <td class="editor"><input type="text" name="City" id="city" value="<?=$zRow['city']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">State:</div></td>
     <td class="editor"><input type="text" name="State" id="state" value="<?=$zRow['state']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">Zip Code:</div></td>
     <td class="editor"><input type="text" name="Zip_Code" id="zip" value="<?=$atRow['Zip']?>"></td>
    </tr>
    <tr class="editor">
     <td class="editor"><div class="ed1">Phone:</div></td>
     <td class="editor"><input type="text" name="Phone_Number" value="<?=$atRow['Phone_Number']?>"></td>
    </tr>
<?
      }
?>
